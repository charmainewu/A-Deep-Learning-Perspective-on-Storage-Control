# -*- coding: utf-8 -*-
"""
Created on Fri Jul 10 21:59:47 2020
...
BAD = BenchmarkInAccurateDemand(Capacity, Window, Ntrain, Ntest,Nvalid, Backday, Interval, Price, Demand, Renewables, PriceModel, WindModel,PriceScalar,WindScalar,WindStackData,PriceStackData,LSTM)
#cost_deta= BAD.deta()
#cost_mpc= BAD.mpc()
#cost_rl= BAD.rl()
#cost_thb= BAD.thb()
...
np.save("./data/500/cost_deta.npy",cost_deta)
np.save("./data/500/cost_mpc.npy",cost_mpc)
np.save("./data/500/cost_rl.npy",cost_rl)
np.save("./data/500/cost_thb.npy",cost_thb)
np.save("./data/500/cost_ofl.npy",cost_ofl)
np.save("./data/500/cost_nos.npy",cost_nos)
np.save("./data/500/cost_peta.npy",cost_peta)
np.save("./data/500/cost_veta.npy",cost_veta)
np.save("./data/500/cost_seta.npy",cost_seta)
