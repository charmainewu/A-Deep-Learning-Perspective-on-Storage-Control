# -*- coding: utf-8 -*-
"""
Created on Fri Jan 24 18:35:33 2020
...
model.save("./winddata/step/6/point.h5")
...
for n_outputs in range(5):
    ...
    for i in range(BACK_DAY,BACK_DAY+600):
        ...
        for j in range(n_outputs):
            ...
            test_predict_a.append(scaler_r.inverse_transform(test_predict_v)[0][0])
        test_predict.append(test_predict_a)
        test_y.append(scaler_r.inverse_transform([test[i:i+n_outputs,0]])[0])
...
np.save("./winddata/step/6/singlemae.npy",mae)
np.save("./winddata/step/6/singlermse.npy",rmse)
...
model.compile(loss='mean_squared_error', optimizer='adam')
model.fit(x_train, y_train, epochs=150, batch_size=100, validation_data=(x_test, y_test), verbose=2)
model.save("./winddata/step/12/point.h5")
...
mae,rmse = np.array(mae), np.array(rmse)    
np.save("./winddata/step/12/singlemae.npy",mae)
np.save("./winddata/step/12/singlermse.npy",rmse)
...
model.compile(loss='mean_squared_error', optimizer='adam')
model.fit(x_train, y_train, epochs=150, batch_size=100, validation_data=(x_test, y_test), verbose=2)
model.save("./winddata/step/24/point.h5")
...
mae,rmse = np.array(mae), np.array(rmse)    
np.save("./winddata/step/24/singlemae.npy",mae)
np.save("./winddata/step/24/singlermse.npy",rmse)
...
model.compile(loss='mean_squared_error', optimizer='adam')
model.fit(x_train, y_train, epochs=150, batch_size=100, validation_data=(x_test, y_test), verbose=2)
model.save("./winddata/state/16/point.h5")
...
mae,rmse = np.array(mae), np.array(rmse)    
np.save("./winddata/state/16/singlemae.npy",mae)
np.save("./winddata/state/16/singlermse.npy",rmse)
...
model.compile(loss='mean_squared_error', optimizer='adam')
model.fit(x_train, y_train, epochs=150, batch_size=100, validation_data=(x_test, y_test), verbose=2)
model.save("./winddata/state/64/point.h5")
...
mae,rmse = np.array(mae), np.array(rmse)    
np.save("./winddata/state/64/singlemae.npy",mae)
np.save("./winddata/state/64/singlermse.npy",rmse)
...
model.compile(loss='mean_squared_error', optimizer='adam')
model.fit(x_train, y_train, epochs=150, batch_size=100, validation_data=(x_test, y_test), verbose=2)
model.save("./winddata/state/128/point.h5")
...
mae,rmse = np.array(mae), np.array(rmse)    
np.save("./winddata/state/128/singlemae.npy",mae)
np.save("./winddata/state/128/singlermse.npy",rmse)
...
model.compile(loss='mean_squared_error', optimizer='adam')
model.fit(x_train, y_train, epochs=150, batch_size=100, validation_data=(x_test, y_test), verbose=2)
model.save("./winddata/layer/1/point.h5")
...
mae,rmse = np.array(mae), np.array(rmse)    
np.save("./winddata/layer/1/singlemae.npy",mae)
np.save("./winddata/layer/1/singlermse.npy",rmse)
...
model.compile(loss='mean_squared_error', optimizer='adam')
model.fit(x_train, y_train, epochs=150, batch_size=100, validation_data=(x_test, y_test), verbose=2)
model.save("./winddata/layer/2/point.h5")
...
mae,rmse = np.array(mae), np.array(rmse)    
np.save("./winddata/layer/2/singlemae.npy",mae)
np.save("./winddata/layer/2/singlermse.npy",rmse)
...
model.compile(loss='mean_squared_error', optimizer='adam')
model.fit(x_train, y_train, epochs=150, batch_size=100, validation_data=(x_test, y_test), verbose=2)
model.save("./winddata/layer/3/point.h5")
...
mae,rmse = np.array(mae), np.array(rmse)    
np.save("./winddata/layer/3/singlemae.npy",mae)
np.save("./winddata/layer/3/singlermse.npy",rmse)