# -*- coding: utf-8 -*-
"""
Created on Fri Jan 24 13:51:34 2020
...
for n_outputs in range(5):   
    ...
    model.fit(x_train, y_train, epochs=150, batch_size=100, validation_data=(x_test, y_test), verbose=0)
    model.save("./pricedata/step/6/vector"+str(n_outputs)+".h5")
    
    #model = load_model("./pricedata/vector"+str(n_outputs)+".h5")
...
np.save("./pricedata/step/6/vectormae.npy",mae)
np.save("./pricedata/step/6/vectorrmse.npy",rmse)
...
for n_outputs in range(5):   
    ...
    model.compile(loss='mean_squared_error', optimizer='adam')
    model.fit(x_train, y_train, epochs=150, batch_size=100, validation_data=(x_test, y_test), verbose=0)
    model.save("./pricedata/step/12/vector"+str(n_outputs)+".h5")
...
mae,rmse = np.array(mae), np.array(rmse)  
np.save("./pricedata/step/12/vectormae.npy",mae)
np.save("./pricedata/step/12/vectorrmse.npy",rmse)
...
for n_outputs in range(5):   
    ...
    model.compile(loss='mean_squared_error', optimizer='adam')
    model.fit(x_train, y_train, epochs=150, batch_size=100, validation_data=(x_test, y_test), verbose=0)
    model.save("./pricedata/step/24/vector"+str(n_outputs)+".h5")
...
mae,rmse = np.array(mae), np.array(rmse)  
np.save("./pricedata/step/24/vectormae.npy",mae)
np.save("./pricedata/step/24/vectorrmse.npy",rmse)
...
for n_outputs in range(5):   
    ...
    model.compile(loss='mean_squared_error', optimizer='adam')
    model.fit(x_train, y_train, epochs=150, batch_size=100, validation_data=(x_test, y_test), verbose=0)
    model.save("./pricedata/state/16/vector"+str(n_outputs)+".h5")
...
mae,rmse = np.array(mae), np.array(rmse)  
np.save("./pricedata/state/16/vectormae.npy",mae)
np.save("./pricedata/state/16/vectorrmse.npy",rmse)
...
for n_outputs in range(5):   
    ...
    model.compile(loss='mean_squared_error', optimizer='adam')
    model.fit(x_train, y_train, epochs=150, batch_size=100, validation_data=(x_test, y_test), verbose=0)
    model.save("./pricedata/state/64/vector"+str(n_outputs)+".h5")
...
mae,rmse = np.array(mae), np.array(rmse)  
np.save("./pricedata/state/64/vectormae.npy",mae)
np.save("./pricedata/state/64/vectorrmse.npy",rmse)
...
for n_outputs in range(5):   
    ...
    model.compile(loss='mean_squared_error', optimizer='adam')
    model.fit(x_train, y_train, epochs=150, batch_size=100, validation_data=(x_test, y_test), verbose=0)
    model.save("./pricedata/state/128/vector"+str(n_outputs)+".h5")
...
mae,rmse = np.array(mae), np.array(rmse)  
np.save("./pricedata/state/128/vectormae.npy",mae)
np.save("./pricedata/state/128/vectorrmse.npy",rmse)
...
for n_outputs in range(5):   
    ...
    model.compile(loss='mean_squared_error', optimizer='adam')
    model.fit(x_train, y_train, epochs=150, batch_size=100, validation_data=(x_test, y_test), verbose=0)
    model.save("./pricedata/layer/1/vector"+str(n_outputs)+".h5")
...
mae,rmse = np.array(mae), np.array(rmse)  
np.save("./pricedata/layer/1/vectormae.npy",mae)
np.save("./pricedata/layer/1/vectorrmse.npy",rmse)
...
for n_outputs in range(5):   
    ...
    model.compile(loss='mean_squared_error', optimizer='adam')
    model.fit(x_train, y_train, epochs=150, batch_size=100, validation_data=(x_test, y_test), verbose=0)
    model.save("./pricedata/layer/2/vector"+str(n_outputs)+".h5")
...
mae,rmse = np.array(mae), np.array(rmse)  
np.save("./pricedata/layer/2/vectormae.npy",mae)
np.save("./pricedata/layer/2/vectorrmse.npy",rmse)
...
for n_outputs in range(5):   
    ...
    model.compile(loss='mean_squared_error', optimizer='adam')
    model.fit(x_train, y_train, epochs=150, batch_size=100, validation_data=(x_test, y_test), verbose=0)
    model.save("./pricedata/layer/3/vector"+str(n_outputs)+".h5")
...
mae,rmse = np.array(mae), np.array(rmse)  
np.save("./pricedata/layer/3/vectormae.npy",mae)
np.save("./pricedata/layer/3/vectorrmse.npy",rmse)