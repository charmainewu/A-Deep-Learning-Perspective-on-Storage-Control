# -*- coding: utf-8 -*-
"""
Created on Fri Jan 24 18:17:12 2020
...
for n_outputs in range(5):
    ...
    model.save_weights("./winddata/step/6/s2s"+str(n_outputs)+".h5")
...
np.save("./winddata/step/6/s2smae.npy",mae)
np.save("./winddata/step/6/s2srmse.npy",rmse)
...
for n_outputs in range(5):
    ...
    model.compile(loss='mse', optimizer='adam')
    model.fit(x_train, y_train, epochs=50, batch_size=100, validation_data=(x_test, y_test), verbose=2)
    model.save_weights("./winddata/step/12/s2s"+str(n_outputs)+".h5")
...
mae,rmse = np.array(mae), np.array(rmse) 
np.save("./winddata/step/12/s2smae.npy",mae)
np.save("./winddata/step/12/s2srmse.npy",rmse)
...
for n_outputs in range(5):
    ...
    model.compile(loss='mse', optimizer='adam')
    model.fit(x_train, y_train, epochs=50, batch_size=100, validation_data=(x_test, y_test), verbose=2)
    model.save_weights("./winddata/step/24/s2s"+str(n_outputs)+".h5")
...
mae,rmse = np.array(mae), np.array(rmse) 
np.save("./winddata/step/24/s2smae.npy",mae)
np.save("./winddata/step/24/s2srmse.npy",rmse)
...
for n_outputs in range(5):
    ...
    model.compile(loss='mse', optimizer='adam')
    model.fit(x_train, y_train, epochs=50, batch_size=100, validation_data=(x_test, y_test), verbose=2)
    model.save_weights("./winddata/state/16/s2s"+str(n_outputs)+".h5")
...
mae,rmse = np.array(mae), np.array(rmse) 
np.save("./winddata/state/16/s2smae.npy",mae)
np.save("./winddata/state/16/s2srmse.npy",rmse)
...
for n_outputs in range(5):
    ...
    model.compile(loss='mse', optimizer='adam')
    model.fit(x_train, y_train, epochs=50, batch_size=100, validation_data=(x_test, y_test), verbose=2)
    model.save_weights("./winddata/state/64/s2s"+str(n_outputs)+".h5")
...
mae,rmse = np.array(mae), np.array(rmse) 
np.save("./winddata/state/64/s2smae.npy",mae)
np.save("./winddata/state/64/s2srmse.npy",rmse)
...
for n_outputs in range(5):
    ...
    model.compile(loss='mse', optimizer='adam')
    model.fit(x_train, y_train, epochs=50, batch_size=100, validation_data=(x_test, y_test), verbose=2)
    model.save_weights("./winddata/state/128/s2s"+str(n_outputs)+".h5")
...
mae,rmse = np.array(mae), np.array(rmse) 
np.save("./winddata/state/128/s2smae.npy",mae)
np.save("./winddata/state/128/s2srmse.npy",rmse)
...
for n_outputs in range(5):
    ...
    model.compile(loss='mse', optimizer='adam')
    model.fit(x_train, y_train, epochs=50, batch_size=100, validation_data=(x_test, y_test), verbose=2)
    model.save_weights("./winddata/layer/1/s2s"+str(n_outputs)+".h5")
...
mae,rmse = np.array(mae), np.array(rmse) 
np.save("./winddata/layer/1/s2smae.npy",mae)
np.save("./winddata/layer/1/s2srmse.npy",rmse)
...
for n_outputs in range(5):
    ...
    model.compile(loss='mse', optimizer='adam')
    model.fit(x_train, y_train, epochs=50, batch_size=100, validation_data=(x_test, y_test), verbose=2)
    model.save_weights("./winddata/layer/2/s2s"+str(n_outputs)+".h5")
...
mae,rmse = np.array(mae), np.array(rmse) 
np.save("./winddata/layer/2/s2smae.npy",mae)
np.save("./winddata/layer/2/s2srmse.npy",rmse)
...
for n_outputs in range(5):
    ...
    model = Seq2Seq(output_dim=1, hidden_dim=64, output_length=n_outputs, input_shape=(x_train.shape[1], x_train.shape[2]), peek=False, depth=3,dropout=0.2)
    model.compile(loss='mse', optimizer='adam')
    model.fit(x_train, y_train, epochs=50, batch_size=100, validation_data=(x_test, y_test), verbose=2)
    model.save_weights("./winddata/layer/3/s2s"+str(n_outputs)+".h5")
...
mae,rmse = np.array(mae), np.array(rmse) 
np.save("./winddata/layer/3/s2smae.npy",mae)
np.save("./winddata/layer/3/s2srmse.npy",rmse)
